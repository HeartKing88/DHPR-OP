...
async def run_async_clients():
    ...
    try:
        await app.send_message(LOG_GROUP_ID, "**DHPR ᴜsᴇʀʙᴏᴛ ɪs ᴀʟɪᴠᴇ**")
    except:
        pass
    try:
        await app.join_chat("Exampurrs")
        await app.join_chat("FONT_CHANNEL_01")
    except:
        pass
    if SESSION_STRING:
    ...
    try:
        await bot.send_message(LOG_GROUP_ID, "**DHPR ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ.**")
    except:
        pass
